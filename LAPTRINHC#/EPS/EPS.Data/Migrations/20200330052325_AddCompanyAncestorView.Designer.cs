...
namespace EPS.Data.Migrations
{
    ...
    [Migration("20200330052325_AddCompanyAncestorView")]
    partial class AddCompanyAncestorView
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPS.Data.Entities.CompanyAncestor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CompanyAncestorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyAncestorId");

                    b.HasIndex("CompanyId");

                    b.ToTable("CompanyAncestors");
                });
            ...
            modelBuilder.Entity("EPS.Data.Entities.Company", b =>
                {
                    b.HasOne("EPS.Data.Entities.Company", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("EPS.Data.Entities.CompanyAncestor", b =>
                {
                    b.HasOne("EPS.Data.Entities.Company", "Ancestor")
                        .WithMany("Descendants")
                        .HasForeignKey("CompanyAncestorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
