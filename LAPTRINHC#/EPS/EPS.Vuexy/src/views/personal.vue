          ...
          <b-form @submit.prevent="save" autocomplete="off">
            ...
            <b-row>
              <b-col md="6" offset="3">
                ...
                >
                  <template slot="label"
                    >{{ $t("System.User.List.SearchForm.UserName") }}
                  </template>
            ...
            <b-row>
              <b-col md="6" offset="3">
                <b-form-group
                  :label="this.$t('ChangePassword.List.Form.OldPass')"
                  label-for="ExPass"
                  :label-cols="4"
                  label-align-md="left"
                  :horizontal="true"
                ...
                >
                  <template slot="label"
                    >{{ $t("ChangePassword.List.Form.OldPass") }}
                    <span class="required">(*)</span></template
                  >
                  <b-form-input
                    type="password"
                    ...
                    :state="
                      $v.user.exPass.$dirty ? !$v.user.exPass.$error : null
                    "
                  >
                  </b-form-input>
            ...
            <b-row>
              <b-col md="6" offset="3">
                ...
                >
                  <template slot="label"
                    >{{ $t("ChangePassword.List.Form.NewPass") }}
                    <span class="required">(*)</span></template
                  >
                  <b-form-input
                    type="password"
                  ...
                  <b-form-invalid-feedback
                    v-if="!$v.user.newPassword.minLength"
                  >
                  ...
                  <b-form-invalid-feedback
                    v-if="
                      ...
                      !$v.user.newPassword.passwordPattern
                    "
                  >
                    {{
            ...
            <b-row>
              <b-col md="6" offset="3">
                ...
                >
                  <template slot="label"
                    >{{ $t("ChangePassword.List.Form.NewPassConfirmation") }}
                    <span class="required">(*)</span></template
                  >
                  <b-form-input
                    type="password"
                    ...
                    :state="
                      $v.user.newPasswordConfirmation.$dirty
                        ? !$v.user.newPasswordConfirmation.$error
                        : null
                    "
                  >
                  </b-form-input>
                  <b-form-invalid-feedback
                    v-if="!$v.user.newPasswordConfirmation.sameAsPassword"
                  >
                    {{
...
export default {
  ...
  created() {
    ...
    this.$services
      .get("lookup/roles")
      .done((response) => (vm.listRoles = response));
    this.loadUserDetail();
    // this.loadCompany();
  },
  methods: {
