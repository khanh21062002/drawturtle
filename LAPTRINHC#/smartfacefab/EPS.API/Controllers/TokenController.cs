...
namespace EPS.API.Controllers
{
    ...
    public class TokenController : BaseController
    {
        ...
        public TokenController(IOptions<Audience> settings, Data.EPSContext context, IOptions<AppSettings> appSettings)
        {
        ...
        private string GetJwt(string client_id, string refresh_token, User user)
        {
            ...
            var claims = new Claim[]
            {
                ...
                new Claim(CustomClaimTypes.CompId, user.CompId.ToString())
            };
            ...
            var response = new
            {
                ...
                userId = user.Id,
                comId = user.CompId,
                cameraLink = _appSettings.CameraLink,
                privileges
            };
