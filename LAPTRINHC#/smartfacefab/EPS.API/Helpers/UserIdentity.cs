...
namespace EPS.API.Helpers
{
    public class UserIdentity : IUserIdentity<int>
    {
        ...
        public Nullable<int>  Id { get => Convert.ToInt32(GetClaimValue(CustomClaimTypes.Id)); }
        public Nullable<int> CompId { get => Convert.ToInt32(GetClaimValue(CustomClaimTypes.CompId)); }
    }
}
