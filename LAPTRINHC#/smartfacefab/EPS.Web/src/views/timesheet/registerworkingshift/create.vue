    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t("Timesheet.RegisterWorkingShift.Create.Header")}}</strong>
                    </div>
                    <b-form @submit.prevent="save" @submit="$v.$touch()">
                        <b-row>
                            <b-col md="11">
                                <b-row>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.Company')"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left"
                                                      label-class="required">
                                            <select2 :placeholder="this.$t('PlaceHolder.Select')" :disabled="true"
                                                     v-model="registerworkingshift.compId" :options="lstcompany">
                                            </select2>
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.Type')"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left"
                                                      label-class="required">
                                ...
                                <b-row>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.DepartmentName')"
                                                      v-if="showDept"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                            ...
                                            <!--<select2 :placeholder="this.$t('PlaceHolder.Select')" @change="loadListPersonByDept($event)"
                                            ...
                                            <b-form-invalid-feedback>
                                                {{$t('Timesheet.RegisterWorkingShift.Create.Form.DepartmentRequire')}}
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.EmployeeName')"
                                                      v-if="showPerson"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left" label-class="required">
                                            ...
                                            <b-form-invalid-feedback>
                                                {{$t('Timesheet.RegisterWorkingShift.Create.Form.EmployeeRequire')}}
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                    </b-col>
                                </b-row>
                                <b-row>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.DateFrom')"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left" label-class="required">
                                            <b-form-input type="text" style="display: none"
                                            ...
                                            <b-form-invalid-feedback>
                                                {{$t('Timesheet.RegisterWorkingShift.Create.Form.DateRequire')}}
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                    </b-col>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.DateTo')"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left" label-class="required">
                                            <b-form-input type="text" style="display: none"
                                            ...
                                            <date-picker style="width: 100%;" type="date" v-model="registerworkingshift.dateTo" id="ID" valueType="YYYY-MM-DD" format="DD-MM-YYYY"></date-picker>
                                            ...
                                            <b-form-invalid-feedback v-if="!$v.registerworkingshift.dateTo.greaterFrom">
                                                {{$t('Timesheet.RegisterWorkingShift.Create.Form.DateToRequire')}}
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                    </b-col>
                                </b-row>
                                <b-row>
                                    <b-col md="6">
                                        <b-form-group :label="this.$t('Timesheet.RegisterWorkingShift.Create.Form.Note')"
                                                      :label-cols="4"
                                                      :horizontal="true"
                                                      label-align-md="left">
                        ...
                        <b-row>
                            <b-col md="7">
                                <h2>{{$t("Timesheet.RegisterWorkingShift.Create.HeaderTable")}}</h2>
                            </b-col>
                        </b-row>
                        <b-row>
                            <b-col md="12">
                        ...
                        <b-row>
                            <b-col class="text-center">
                                <b-form-group>
                                    <b-button v-if="authorize(['ManageRegisterWorkingShift'])" type="submit" variant="primary"><i class="fa fa-floppy-o"></i> {{$t("Button.Submit")}}</b-button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                lsttype: [],
                detailsField: [
                    { key: 'index', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Index'), sortable: false },
                    { key: 'name', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.NameShift'), sortable: false },
                    { key: 'monday', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Monday'), sortable: false },
                    { key: 'tueDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Tuesday'), sortable: false, },
                    { key: 'wedDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Wednesday') },
                    { key: 'thuDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Thursday') },
                    { key: 'friDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Friday') },
                    { key: 'satDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Saturday') },
                    { key: 'sunDay', label: this.$t('Timesheet.RegisterWorkingShift.Create.Field.Sunday') },
                ],
                treeselect: {
                    value: null,
                    options: [],
        ...
        methods: {
            ...
            initDetails() {
                ...
                item0.id = 0;
                item0.value = 0;
                item0.text = i18n.t("Timesheet.RegisterWorkingShift.Create.InitDetail.Company");
                vm.lsttype.push(item0);
                let item = {};
                item.id = 1;
                item.value = 1;
                item.text = i18n.t("Timesheet.RegisterWorkingShift.Create.InitDetail.Department");
                vm.lsttype.push(item);
                let item2 = {};
                item2.id = 2;
                item2.value = 2;
                item2.text = i18n.t("Timesheet.RegisterWorkingShift.Create.InitDetail.Employee");
            ...
            async save() {
                ...
                if (!this.$v.$invalid) {
                    var vm = this;
                    vm.registerworkingshift.listDetails = [];
                    vm.registerworkingshift.listDetails = vm.listDetails;
                    this.$services.post('timesheet/register-working-shift', vm.registerworkingshift).done((id) => {
                        vm.$toastr.s(i18n.t("Messages.ConfirmCreate"));
                        vm.$router.push({ path: '/timesheet/register-working-shift/list' });
                    });
                }
            },
