    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t("School.Parent.List.Table.Header")}}</strong>
                        <a class="btn btn-success" v-if="lang == 'vi'" style="float: right; color: white;" href="download/template_PhuHuynh.xlsx">{{$t("Categories.Person.List.Table.ImportSample")}}</a>
                        <a class="btn btn-success" v-if="lang == 'en'" style="float: right; color: white;" href="download/template_Parent.xlsx">{{$t("Categories.Person.List.Table.ImportSample")}}</a>
                    </div>
                            ...
                            <b-col md="12">
                                <b-form-group :label="this.$t('Categories.Person.List.Table.Import')"
                                    ...
                                    <b-form-file ref="file-input"
                                                 ...
                                                 :placeholder="this.$t('School.Parent.List.Table.ImportPlaceholder')"></b-form-file>
        ...
        methods: {
            ...
            save() {
                ...
                if (!this.$v.file.$invalid) {
                    this.$services.post('person/parent/import/', this.file).done((res) => {
                        //clear file
