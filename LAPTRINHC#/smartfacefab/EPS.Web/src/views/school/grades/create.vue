    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t('School.Grades.Create.Header')}}</strong>
                    </div>
                    <b-form @submit.prevent="save">
                        <b-row>
                            <b-col md="6" offset="3">
                                <b-form-group :label="this.$t('Timesheet.Dayoff.List.SearchForm.CompanyName')"
                                              ...
                                              :horizontal="true"
                                              label-align-md="left">
                                    <select2 style="width: 100% !important;height: 100%; margin: 0; padding: 0;" class="col-sm-12" :placeholder="this.$t('PlaceHolder.Select')" :disabled="true"
                        ...
                        <b-row>
                            <b-col md="6" offset="3">
                                <b-form-group :label="this.$t('School.Grades.Detail.Label.Unit')"
                                    ...
                                    <select2 style="width: 100% !important; margin: 0; padding: 0;" class="col-sm-12" :placeholder="this.$t('PlaceHolder.Select')"
                        ...
                        <b-row>
                            <b-col md="6" offset="3">
                                <b-form-group :label="this.$t('School.Grades.Detail.Label.Descriptions')"
                                              ...
                                              :horizontal="true"
                                              label-align-md="left">
                                    <b-form-input type="text" id="txt_descriptions"
                        ...
                        <b-row>
                            <b-col class="text-center">
                                <b-form-group>
                                    <b-button v-if="authorize(['ManageGrades'])" type="submit" variant="primary"><i class="fa fa-floppy-o"></i> {{$t("Button.Submit")}}</b-button>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                if (!this.$v.$invalid) {
                    var vm = this;
                    this.$services.post('grades', this.grades).done((id) => {
                        vm.$toastr.s(i18n.t("Messages.ConfirmCreate"));
                        vm.$router.push({ path: '/school/grades/list' });
                    });
                }
            },
            cancel() {
