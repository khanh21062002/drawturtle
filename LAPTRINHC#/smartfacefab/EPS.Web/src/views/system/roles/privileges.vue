    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t('System.Role.Privileges.Header')}}</strong>
                    </div>
                    <b-form @submit.prevent="save" style="min-height: 500px">
                        <b-row>
                            <b-col md="4">
                                <b-form-group :label="this.$t('System.Role.Privileges.Label.CategoriesList')"
                                              label-for="module">
                            ...
                            <b-col md="8">
                                <b-form-group :label="this.$t('System.User.Privileges.Label.Categories') +' '+ selectedModule.name.toLowerCase()"
                                    ...
                                    <b-form-checkbox-group id="privileges"
...
<script>
    ...
    export default {
        ...
        created() {
            var vm = this;
            this.$services.get(`roles/${this.$route.params.roleId}/privileges`).done((privileges) => {
        ...
        methods: {
            ...
            save() {
                ...
                this.$services.put(`roles/${this.$route.params.roleId}/privileges?privileges=${data}`).done(() => {
