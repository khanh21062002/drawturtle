        ...
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>
                            {{$t("Nav.InOutEmployeeList.ListAccess")}}
                        </strong>
                    </div>
                    <b-form @submit.prevent="search">
                        ...
                        <b-row>
                            <b-col md="12" style="height: 1000px; padding-top: 20px;" v-show="showReport">
                                <WebDocumentViewer ref="refReportGuess"
                                                   :reportUrl="reportUrl"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.locale == "vi") {
                this.reportUrl = 'ReportGuess?p_lang=' + this.locale;
        ...
        methods: {
            report() {
                ...
                var clientParameter = this.$refs.refReportGuess.getClientParameter();
                ...
                this.$refs.refReportGuess.refresh();
