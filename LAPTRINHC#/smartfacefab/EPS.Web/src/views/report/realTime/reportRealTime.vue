    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t('Nav.RealTimeList.Header')}}</strong>
                    </div>
                    <b-form @submit.prevent="search">
                        ...
                        <WebDocumentViewer ref="refReportRealTime" :reportUrl="reportUrl" style="height: 800px;"></WebDocumentViewer>
                    </b-form>
                    <br />
                </b-card>
            </b-col>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.reportUrl = 'ReportRealTime?p_lang=' + this.locale + '&p_company=' + accessToken.comId;
        ...
        methods: {
            report() {
                ...
                var clientParameter = this.$refs.refReportRealTime.getClientParameter();
                ...
                this.$refs.refReportRealTime.refresh();
            },
            search() {
