    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t('ReportWorkingTime.Header')}}</strong>
                    </div>
                    <b-form @submit.prevent="search">
                        <b-row>
                            <b-col md="6">
                                <b-form-group :label="this.$t('ReportWorkingTime.FromDate')"
                                              :label-cols="4"
                                              :horizontal="true"
                                              label-align-md="left"
                                    ...
                                    <b-form-invalid-feedback>
                                        {{$t('ReportWorkingTime.RequireDateMsg')}}
                                    </b-form-invalid-feedback>
                                </b-form-group>
                            </b-col>
                            <b-col md="6">
                                <b-form-group :label="this.$t('ReportWorkingTime.ToDate')"
                                              :label-cols="4"
                                              :horizontal="true"
                                              label-align-md="left"
                                              label-class="required">
                        ...
                        <b-row>
                            <b-col md="6">
                                <b-form-group :label="this.$t('ReportWorkingTime.Department')"
                                              :label-cols="4"
                                              :horizontal="true"
                                              label-align-md="left">
                                    <!--<select2 :placeholder="this.$t('PlaceHolder.Select')" id="lstdepartment" :settings="{ allowClear: true }"
                        ...
                        <b-row>
                            <b-col md="12">
                                <div style="text-align: center">
                                    <b-button size="md" class="btn btn-success" @click="report"><i class="fa fa-file-excel-o"></i> {{$t('ReportWorkingTime.CreateButton')}}</b-button>
                                </div>
                            </b-col>
                        </b-row>
                        <WebDocumentViewer ref="refReportWorkingHour" :reportUrl="reportUrl" style="height: 800px;"></WebDocumentViewer>
                    </b-form>
                    <br />
                </b-card>
            </b-col>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.locale == "vi") {
                this.reportUrl = 'ReportWorkingHour?p_lang=' + this.locale + '&' + 'p_company=' + accessToken.comId + '&p_departmentName=Tất cả';
            } else {
                this.reportUrl = 'ReportWorkingHour?p_lang=' + this.locale + '&' + 'p_company=' + accessToken.comId + '&p_departmentName=All';
            }
        ...
        methods: {
            report() {
                ...
                var clientParameter = this.$refs.refReportWorkingHour.getClientParameter();
                ...
                this.$refs.refReportWorkingHour.refresh();
            },
