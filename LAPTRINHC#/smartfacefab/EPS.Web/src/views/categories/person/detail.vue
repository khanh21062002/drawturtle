    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t("Categories.Person.Detail.Header")}}</strong>
                    </div>
                                    ...
                                    <b-col md="12">
                                        <b-form-group :label="this.$t('Reporting.Event.List.SearchForm.PersonType')"
                                            ...
                                            <b-form-input type="text"
                                                          ...
                                                          :state="$v.person.personType.$error ? false : null">
                                            </b-form-input>
                                            <b-form-invalid-feedback>
                                            ...
                                            <b-form-input :disabled="!editing"
                                                          v-if="!editing"
                                                          :value="this.lstpersonType.filter((personType)=>
                                                person.personType == personType.id).map((element) => element.text).join(',')">
                                            </b-form-input>
                                        </b-form-group>
                                    </b-col>
                                </b-row>
                                ...
                                <b-row>
                                    <b-col md="12">
                                        <b-form-group :label="this.$t('Guess.Detail.Form.Gender')"
                                                      ...
                                                      label-align-md="left">
                                            <select2 :placeholder="this.$t('PlaceHolder.Select')"
                                                     :settings="{allowClear: true}" v-if="editing"
                                                     v-model="person.gender" :options="lstGender">
                                            </select2>
                                            <b-form-input :disabled="!editing"
                                                          v-if="!editing"
    ...
    export default {
        ...
        methods: {
            ...
            async loadPersonDetail() {
                var vm = this;
                return this.$services.get(`person/${this.personId}`).done(person => {
                    vm.person = person;
                });
            },
            edit() {
            ...
            convertDataStatus(value) {
                return this.lstpersonType
                    .filter((personType) => value == personType.id)
