    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>{{$t("Categories.Person.List.Table.Header")}}</strong>
                        <a class="btn btn-success" v-if="lang == 'vi'" style="float: right; color: white;" href="download/template_NhanVien.xlsx">{{$t("Categories.Person.List.Table.ImportSample")}}</a>
                        <a class="btn btn-success" v-if="lang == 'en'" style="float: right; color: white;" href="download/template_Employee.xlsx">{{$t("Categories.Person.List.Table.ImportSample")}}</a>
                    </div>
                            ...
                            <b-col md="12">
                                <b-form-group :label="this.$t('Categories.Person.List.Table.Import')"
                                    ...
                                    <b-form-file ref="file-input"
                                                 ...
                                                 :placeholder="this.$t('Categories.Person.List.Table.ImportPlaceholder')"></b-form-file>
                        ...
                        <b-row>
                            <b-col md="6" offset="3">
                                <b-form-group :label-cols="4"
                                              :horizontal="true">
                                    <b-button v-if="authorize(['ManageEmployee'])" type="submit" variant="primary"><i class="fa fa-floppy-o"></i> {{$t("Button.Submit")}}</b-button>
        ...
        methods: {
            ...
            save() {
                ...
                if (!this.$v.file.$invalid) {
                    this.$services.post('person/import', this.file).done((res) => {
                        //clear file
