...
namespace ArcFaceSDK.Utils
{
    ...
    public static class ASFFunctions
    {
        ...
        public static extern int ASFFaceFeatureCompare(IntPtr pEngine, IntPtr faceFeature1, IntPtr faceFeature2, ref float confidenceLevel, ASF_CompareModel compareModel = ASF_CompareModel.ASF_ID_PHOTO);
